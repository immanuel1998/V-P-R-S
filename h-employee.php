	 ...
	 <main class="mdl-layout__content mdl-color--grey-100">
        ...
        <div class="mdl-grid">
			...
			<?php
                    ...
                    $sql ="SELECT * FROM employee_vehicles";
                    ...
                    if($result = $dbconn->query($sql)){
                        if($result->num_rows > 0){
                            ...
                            echo "<h4 style='text-align:center;'>Total Registered (Employee Service Vehicles) : "."( ".$rows[0]." )"."</h4>";  
                            ...
                            echo "<table id='myTable' class='row-border hover stripe mdl-shadow--2dp ' style='width:100%;'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th class='mdl-data-table__cell--non-numeric'>Employee ID</th>";
                                        echo "<th class='mdl-data-table__cell--non-numeric'>Position</th>";
                                        echo "<th class='mdl-data-table__cell--non-numeric'>Division</th>";
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                        ...
                                        echo "<td class='mdl-data-table__cell--non-numeric'>" . $row['EmployeeID'] . "</td>";
                                        echo "<td class='mdl-data-table__cell--non-numeric'>" . $row['Position'] . "</td>";
                                        echo "<td class='mdl-data-table__cell--non-numeric'>" . $row['Division'] . "</td>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='edit_employee.php?ID=". $row['ID'] ."' title='Edit Record' data-toggle='tooltip'><img src='assets/images/edit.png' width='25'></a>";
                                            echo ' ';

                                            echo "<a href='delete_employee.php?ID=". $row['ID'] ."' title='Delete Record' data-toggle='tooltip'><img src='assets/images/delete.png' width='25'></a>";
			 ...
			 <div class="mdl-card__actions mdl-card--border">
			    <a class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" style="background-color: #2ecc71; color: white;" href="add_employee.php">
					  Register New Vehicle
				</a>
                <a class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" style="color: white;" href="TCPDF/User/employee_vehicles.php">
                      Get PDF
                </a>
              </div>
			  </div>
